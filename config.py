...
class Config(object):
    ...
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '833465134 1645068158').split()]
...
<b>Bot Is Made By @Madflix_Bots</b></blockquote>"""
